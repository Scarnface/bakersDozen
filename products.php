...
<section class="productOverview">
  ...
  <div class="products">
    <div class="container">
      <div class="productImage">
        <img src="dist/assets/img/Optimized-bread-min.jpg" alt="Savoury Bread" />
      </div>
      <div class="productDescription">
        <h3>Savoury Breads</h3>
        <p>
  ...
  <div class="products">
    <div class="container">
      <div class="productImage">
        <img src="dist/assets/img/Optimized-pastries-min.jpg" alt="Pastries" />
      </div>
      <div class="productDescription">
        <h3>Pastries</h3>
        <p>
  ...
  <div class="products">
    <div class="container">
      <div class="productImage">
        <img src="dist/assets/img/Optimized-cakes-min.jpg" alt="Cakes" />
      </div>
      <div class="productDescription">
        <h3>Cakes</h3>
        <p>
  ...
  <div class="products">
    <div class="container">
      <div class="productImage">
        <img src="dist/assets/img/Optimized-birthday-min.jpg" alt="Birthday Cakes" />
      </div>
      <div class="productDescription">
  ...
  <div class="products">
    <div class="container">
      <div class="productImage">
        <img src="dist/assets/img/Optimized-wedding-min.jpg" alt="Wedding Cakes" />
      </div>
      <div class="productDescription">
        <h3>Wedding Cakes</h3>
        <p>
  ...
  <div class="products">
    <div class="container">
      <div class="productImage">
        <img src="dist/assets/img/Optimized-sandwiches-min.jpg" alt="Sandwiches" />
      </div>
      <div class="productDescription">
        <h3>Sandwiches</h3>
        <p>
